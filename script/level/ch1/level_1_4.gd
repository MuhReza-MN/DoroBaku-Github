...
var lessThan2 = 100
var maxMove = 110
# setel huruf (pastikan lowercase) , setel kiai + y
var h1 = "k"
var h2 = "i"
var h3 = "a"
var h4 = "y"
...
func box_setup() :
	...
	get_tree().get_nodes_in_group("kotak")[0].set_block(h1)
	get_tree().get_nodes_in_group("kotak")[1].set_block(h2)
	get_tree().get_nodes_in_group("kotak")[2].set_block(h3)
	get_tree().get_nodes_in_group("kotak")[3].set_block(h2)
	get_tree().get_nodes_in_group("kotak")[4].set_block(h4)
